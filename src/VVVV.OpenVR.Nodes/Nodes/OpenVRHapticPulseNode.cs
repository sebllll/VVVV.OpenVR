...
{
    [PluginInfo(Name = "HapticPulse", Version = "Split", Category = "OpenVR", Tags = "vr, htc, vive, oculus, rift",
                Help = "controls the Controllers vibration motors", Author = "sebl", Credits = "tonfilm")]
        ...
        public void Evaluate(int SpreadMax)
        {
            ...
            if (FControllerIn != null && system != null)
            {
                ...
                else if (FInHapticEnabled[0])
                {
                    ...
                    var duration = VMath.Map(FInHapticDuration[0], 0, 1, 5, 3999, TMapMode.Clamp);
